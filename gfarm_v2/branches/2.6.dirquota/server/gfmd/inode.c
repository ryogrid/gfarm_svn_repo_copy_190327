/*
 * $Id: inode.c 10409 2017-01-16 05:31:03Z n-soda $
 */
	...
	const char *diag)
{
	...
	if (src_tdirset != dst_tdirset) {
		...
		if (inode_is_dir(src)) {
			 ...
			 */
			if (!user_is_root(process_get_user(process))) {
				/*
