/*
 * $Id: gfperf-write-main.c 6478 2012-08-02 00:22:55Z tatebe $
 */
...
{
	int r;
	static char *optstr = "ht:m:l:b:r::g:o::k:";
#ifdef HAVE_GETOPT_LONG
	int option_index = 0;
...
main(int argc, char *argv[])
{
	...
	if (overwrite_flag)
		r = asprintf(&filename, "%s/overwrite-%s%s%s.tst", dir,
			     filesize_string,
			     gfsd_hostname ? "-" : "",
